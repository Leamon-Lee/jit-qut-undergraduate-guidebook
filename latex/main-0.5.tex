...
\title{\zihao{-2}\bfseries JIT-QUT 项目求生指南}
\author{李京儒~缪彭哲}
\date{2026 年 9 月}
...
\newcolumntype{L}{>{\raggedright\arraybackslash}p{0.58\textwidth}}
\newcolumntype{R}{>{\raggedright\arraybackslash}p{0.28\textwidth}}
\newif\ifcourseopen
\newif\ifcourseheaderprinted
\newcounter{courseitem}
\newcommand{\finishcourse}{%
 \ifcourseopen
 \par\end{minipage}\end{tcolorbox}%
 \courseopenfalse
 \fi
}
\newcommand{\coursereset}{\finishcourse\setcounter{courseitem}{0}\courseheaderprintedfalse}
\newcommand{\courseheader}{%
 \ifcourseheaderprinted\else
 \par\medskip
 \noindent
 \begin{tcolorbox}[
 enhanced,
 ...
 \raggedright\bfseries 学分
 \end{minipage}\hfill
 \begin{minipage}[t]{0.92\linewidth}
 \bfseries 课程描述
 \end{minipage}
 \end{tcolorbox}%
 \courseheaderprintedtrue
 \fi
}
\newenvironment{coursetable}{\par\medskip}{\finishcourse\par\medskip}

\newcommand{\course}[2]{%
 \finishcourse
 \courseheader
 \Needspace{5\baselineskip}%
 \stepcounter{courseitem}%
 \ifodd\value{courseitem}\def\coursebg{white}\else\def\coursebg{black!5}\fi
 \begin{tcolorbox}[
 enhanced,
 colback=\coursebg,
 colframe=\coursebg,
...
\newcommand{\official}[2]{\href{#1}{#2}}
\newcommand{\completedcourse}[2]{\textcolor{black!50}{\href{#1}{\textcolor{blue!50!white}{#2}}\,\checkmark}}
\newcommand{\unavailablemajor}[1]{\textcolor{black!40}{\sout{#1}}}

\let\origsection\section
\renewcommand{\section}{\coursereset\origsection}
\let\origsubsection\subsection
\renewcommand{\subsection}{\coursereset\origsubsection}
\let\origsubsubsection\subsubsection
\renewcommand{\subsubsection}{\coursereset\origsubsubsection}
\let\orignewpage\newpage
\renewcommand{\newpage}{\finishcourse\orignewpage}
\let\origclearpage\clearpage
\renewcommand{\clearpage}{\finishcourse\origclearpage}
...
\end{itemize}
\footnotetext{此处``无法选择''仅指本项目当前的 JIT--QUT 课程衔接安排, 不是 QUT 对所有 Bachelor of Information Technology 学生的通用限制. QUT 官方课程结构中, Major, Complementary Studies 和每学期学习负荷都有独立规定; 本项目最终可选方向, 是否需要补修 Core Unit, 以及能否超出常规 4 门课负荷, 均以个人 Advanced Standing, 开课安排和 QUT 批准的 Study Plan 为准. 课程结构见 \official{https://www.qut.edu.au/courses/bachelor-of-information-technology-enterprise-computing}{QUT BIT 页面}; 标准负荷见 \official{https://www.qut.edu.au/study/international/study-abroad-program/what-can-i-study}{QUT 官方说明}. }
...
\midrule
合计 (twin) & 学费 + 生活费 + twin + 手机 + 公交 + 机票 & 约 A\$69,770--74,720 & 约 ￥334,900--358,700 \\
合计 (ensuite) & 学费 + 生活费 + ensuite + 手机 + 公交 + 机票 & 约 A\$82,770--87,720 & 约 ￥397,300--421,100 \\
\end{longtable} 
\footnotetext{人民币金额统一按 A\$1 = ￥4.80 粗略换算; 机票原始口径为人民币单程约 ￥3,000--5,000, 表中澳元数为反向折算后的近似值.}
\normalsize
...
\clearpage
\section{QUT 2027年学术日历}\label{app:qut-calendar}

以下为 QUT 官方发布的 2027 Academic Calendar. 日历中包含 Semester 1, Semester 2, QUT You, Summer 和考试安排, 原始文件保留横向版式. 来源: \official{https://www.qut.edu.au/about/key-dates-and-academic-calendar/academic-calendar/2027-academic-calendar}{QUT 2027 Academic Calendar 官方页面}.

PS: QUT You 我们不需要学习, 这是给 QUT 大一新生上的公共课.

\begin{figure}[p]
 \centering
 {\small 来源: \official{https://www.qut.edu.au/about/key-dates-and-academic-calendar/academic-calendar/2027-academic-calendar}{QUT 2027 Academic Calendar 官方页面}\par\vspace{0.6em}}
 \includegraphics[page=1,width=\textwidth,height=0.88\textheight,keepaspectratio]{pics/qut-academic-calendar-2027.pdf}
\end{figure}

\clearpage
\section{昆士兰州与布里斯班地理信息}\label{app:geography}

昆士兰州简称昆州. 下面按``澳大利亚--昆士兰州--布里斯班''的顺序递进展示位置关系. 

来源对应: 澳大利亚地图来自\official{https://www.worldmap1.com/map-australia.asp}{WorldMap1}; 昆士兰州地图来自\official{https://www.mapnations.com/countries/australia/states/queensland-map.html}{MapNations}; 布里斯班地图来自\official{https://thingstodoinbrisbanemap.com.au/}{Things to Do in Brisbane Map}.

\begin{figure}[H]
 \centering
 \includegraphics[width=0.8\textwidth]{pics/aus-map.jpg}
 \caption{澳大利亚各州及领地示意图}
 \par\small 来源: \official{https://www.worldmap1.com/map-australia.asp}{WorldMap1 -- Map Australia}
\end{figure}

\clearpage
\begin{figure}[H]
 \centering
 \includegraphics[width=0.8\textwidth]{pics/queensland-map.jpg}
 \caption{昆士兰州地图}
 \par\small 来源: \official{https://www.mapnations.com/countries/australia/states/queensland-map.html}{MapNations -- Queensland Map}
\end{figure}

\clearpage
\begin{figure}[H]
 \centering
 {\small 来源: \official{https://thingstodoinbrisbanemap.com.au/}{Things to Do in Brisbane Map}\par\vspace{0.6em}}
 \includegraphics[page=2,width=1\textwidth]{pics/Brisbane-map.pdf}
 \caption{布里斯班城市地图 (Brisbane-map.pdf 第 2 页)}
\end{figure}

\clearpage
\section{QUT 相关的地图}\label{app:QUT-map}
以下为 Oceania 相关的QUT地图: \official{https://oceania.aib.world/wp-content/uploads/sites/10/2022/08/QUT-Brisbane-Maps.pdf}{QUT Brisbane Maps}.

\begin{figure}[H]
 \centering
 {\small 来源: \official{https://oceania.aib.world/wp-content/uploads/sites/10/2022/08/QUT-Brisbane-Maps.pdf}{QUT Brisbane Maps}\par\vspace{0.6em}}
 \includegraphics[page=1,width=\textwidth,height=0.88\textheight,keepaspectratio]{pics/QUT-Brisbane-Maps.pdf}
\end{figure}
\clearpage
\begin{figure}[p]
 \centering
 {\small 来源: \official{https://oceania.aib.world/wp-content/uploads/sites/10/2022/08/QUT-Brisbane-Maps.pdf}{QUT Brisbane Maps}\par\vspace{0.6em}}
 \includegraphics[page=2,width=\textwidth,height=0.88\textheight,keepaspectratio]{pics/QUT-Brisbane-Maps.pdf}
\end{figure}
\clearpage
\begin{figure}[p]
 \centering
 {\small 来源: \official{https://oceania.aib.world/wp-content/uploads/sites/10/2022/08/QUT-Brisbane-Maps.pdf}{QUT Brisbane Maps}\par\vspace{0.6em}}
 \includegraphics[page=3,width=\textwidth,height=0.88\textheight,keepaspectratio]{pics/QUT-Brisbane-Maps.pdf}
\end{figure}

\clearpage
\section{金陵科技学院 (江宁校区) 地图}\label{app:jit-map}
\begin{figure}[H]
	\centering
	{\small 来源: 金陵科技学院 (江宁校区) 地图, 作者: 李京儒\par\vspace{0.6em}}
	\includegraphics[page=1,width=0.8\textwidth,keepaspectratio]{pics/map.pdf}
	\caption{金陵科技学院 (江宁校区) 地图, 作者: 李京儒}
\end{figure}
\clearpage
...
\begin{figure}[H]
	\centering
	{\small 来源: 异乡好居\par\vspace{0.6em}}
	\includegraphics[width=0.8\textwidth]{pics/room\_1.jpg}
\end{figure}
\clearpage
\begin{figure}[H]
	\centering
	{\small 来源: 异乡好居\par\vspace{0.6em}}
	\includegraphics[width=0.8\textwidth]{pics/room\_2.jpg}
\end{figure}
\end{document}
