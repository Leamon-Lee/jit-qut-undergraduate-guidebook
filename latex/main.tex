...
本项目采用 MIT License. 除第三方材料外, 本仓库中的原创文字、LaTeX 代码、排版结构和原创素材均允许任何人查看、编辑、复制、再发布和用于商业用途, 但必须保留版权声明和许可证文本. 仓库中部分图片、PDF、地图、字体和代码属于第三方材料, 其版权和许可仍归原权利人所有, 使用时必须遵守相应来源的要求. 完整条款见仓库中的 \official{https://github.com/Leamon-Lee/qut-jit-undergraduate-guidebook/blob/master/LICENSE}{MIT License 文件}.
