...
这份指南会随着项目和资料的变化持续修订. 后续你们的先驱者也会持续更新. 本指南的代码库已上传至 \official{https://github.com/Leamon-Lee/qut-jit-undergraduate-guidebook}{GitHub 代码库}, 欢迎通过提交或反馈共同完善内容.

本指南采用 \texttt{VYY.R.D.C} 的版本号规则. 例如, \texttt{V26.5.1.1} 表示: 26 年编写, 2026 年的第 5 个公开版本, 该版本的第 1 次编写修订, 并有 1 位学长学姐确认. 其中最后一位为确认人数: \texttt{0} 表示尚未确认, 数字越大表示已有越多学长学姐核对; 是否达到“广泛确认”应以实际确认范围为准. 当前版本为 \texttt{V26.2.1.0}.

本项目采用《JIT-QUT 项目专用非商业及限定编辑许可》. 项目原创文字、LaTeX 代码和排版结构的版权归作者及获授权贡献者所有. 任何营利性机构不得将本项目内容用于商业用途; 只有 JIT-QUT 项目的经历者或相关校方人员可以编辑并发布衍生版本. 仓库中部分图片、PDF、地图、字体和代码属于第三方材料, 其版权和许可仍归原权利人所有, 使用时必须遵守相应来源的要求. 完整条款见仓库中的 \official{https://github.com/Leamon-Lee/qut-jit-undergraduate-guidebook/blob/master/LICENSE}{LICENSE 文件}.
