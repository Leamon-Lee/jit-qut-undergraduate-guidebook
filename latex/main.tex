...
本指南采用 \texttt{VYY.R.D.C} 的版本号规则. 例如, \texttt{V26.5.1.1} 表示: 26 年编写, 2026 年的第 5 个公开版本, 该版本的第 1 次编写修订, 并有 1 位学长学姐确认. 其中最后一位为确认人数: \texttt{0} 表示尚未确认, 数字越大表示已有越多学长学姐核对; 是否达到“广泛确认”应以实际确认范围为准. 当前版本为 \texttt{V26.1.1.0}.
