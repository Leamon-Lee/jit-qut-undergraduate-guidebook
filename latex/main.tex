...
本指南采用 \texttt{VYY.R.D.C} 的版本号规则, 当前版本为 \texttt{V26.2.2.0}\footnote{版本号中的 \texttt{YY} 为编写年份, \texttt{R} 为该年度的公开版本序号, \texttt{D} 为该版本的编写修订次数, \texttt{C} 为已确认的学长学姐人数. 例如, \texttt{V26.5.1.1} 表示 2026 年第 5 个公开版本的第 1 次编写修订, 并有 1 位学长学姐确认; 是否达到“广泛确认”应以实际确认范围为准.}.
