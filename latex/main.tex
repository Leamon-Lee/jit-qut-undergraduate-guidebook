...
本指南采用 \texttt{VYY.R.D.C} 的版本号规则. 例如, \texttt{V26.5.1.1} 表示: 26 年编写, 2026 年的第 5 个公开版本, 该版本的第 1 次编写修订, 并有 1 位学长学姐确认. 其中最后一位为确认人数: \texttt{0} 表示尚未确认, 数字越大表示已有越多学长学姐核对; 是否达到“广泛确认”应以实际确认范围为准. 当前版本为 \texttt{V26.2.2.0}.

本项目采用 MIT License. 除第三方材料外, 本仓库中的原创文字、LaTeX 代码、排版结构和原创素材均允许任何人查看、编辑、复制、再发布和用于商业用途, 但必须保留版权声明和许可证文本. 仓库中部分图片、PDF、地图、字体和代码属于第三方材料, 其版权和许可仍归原权利人所有, 使用时必须遵守相应来源的要求. 完整条款见仓库中的 \official{https://github.com/Leamon-Lee/jit-qut-undergraduate-guidebook/blob/master/LICENSE}{MIT License 文件}.
...
本名录记录截至当前版本（\texttt{V26.2.2.0}）的主要编写与资料贡献者. 后续新增的内容, 经验分享, 资料整理和校对意见, 将随版本更新持续补充.
...
\begin{itemize}
  \item 尤嘉晨: 提供 QUT 新生与校园相关的照片及资料.
  \item 刘沈晨: 提供 IELTS 备考经验分享.
  \item 参与项目的学长学姐, 同学及校方人员: 提供课程, 项目流程, 申请与生活信息的经验反馈和核对意见.
\end{itemize}
